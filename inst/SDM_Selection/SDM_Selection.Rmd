...
# To add in /inst for vignettes
writeRaster(pred.r, filename = file.path(tmpdir, "predr.tif"))
predrNames <- names(pred.r)
readr::write_rds(predrNames, path = file.path(tmpdir, "predrNames.rds"))
```
...
# To add in /inst for vignettes
readr::write_rds(BestThd, path = file.path(tmpdir, "BestThd.rds"))
```
