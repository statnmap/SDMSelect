...
knitr::include_graphics(Index_Error_on_crossVImg)
```
...
knitr::include_graphics(Help_for_model_ChoiceImg)
```
...
knitr::include_graphics(Param_Exp_DevianceImg)
```
...
knitr::include_graphics(CovForMeanPred_MarginalsImg)
```
...
knitr::include_graphics(Thresholds_for_predictionImg)
```
