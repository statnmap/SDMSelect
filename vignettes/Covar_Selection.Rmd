...
file <- system.file("Covar_Selection", "Param_Exp_Deviance.png", package = "SDMSelect")
...
- Residuals analysis  
```{r, results='asis', echo=FALSE, purl=FALSE}
file <- system.file("Covar_Selection", "Residual-Analysis.png", package = "SDMSelect")
silent <- file.copy(file,"Residual-Analysis.png")
if (dir.exists(here::here("docs/articles"))) { # for pkgdown only
  silent <- file.copy(file, here::here("docs/articles/Residual-Analysis.png"))
}
...
```{r, results='asis', echo=FALSE, purl=FALSE}
file <- system.file("Covar_Selection", "CovForMeanPred_Marginals.png", package = "SDMSelect")
silent <- silent <- file.copy(file, "CovForMeanPred_Marginals.png")
if (dir.exists(here::here("docs/articles"))) { # for pkgdown only
...
```{r, results='asis', echo=FALSE, purl=FALSE}
file <- system.file("Covar_Selection", "Obs-Pred.png", package = "SDMSelect")
silent <- file.copy(file, "Obs-Pred.png")
if (dir.exists(here::here("docs/articles"))) { # for pkgdown only
  silent <- file.copy(file, here::here("docs/articles/Obs-Pred.png"))
}
