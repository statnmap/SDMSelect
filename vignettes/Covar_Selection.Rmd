...
```
```{r, out.width='50%', purl=FALSE, echo=FALSE, fig.cap='Correlation between covariates'}
...
Param_Exp_DevianceImg <- system.file("Covar_Selection", "Param_Exp_Deviance.png", package = "SDMSelect")
...
- Residuals analysis  
```{r, results='asis', echo=FALSE, purl=FALSE}
Residual_AnalysisImg <- system.file("Covar_Selection", "Residual-Analysis.png", package = "SDMSelect")
silent <- file.copy(Residual_AnalysisImg,"Residual-Analysis.png")
...
```{r, results='asis', echo=FALSE, purl=FALSE}
CovForMeanPred_MarginalsImg <- system.file("Covar_Selection", "CovForMeanPred_Marginals.png", package = "SDMSelect")
silent <- silent <- file.copy(CovForMeanPred_MarginalsImg, "CovForMeanPred_Marginals.png")
knitr::include_graphics("CovForMeanPred_Marginals.png")
```

- Comparison of predictions against observations  
```{r, results='asis', echo=FALSE, purl=FALSE}
Obs_PredImg <- system.file("Covar_Selection", "Obs-Pred.png", package = "SDMSelect")
silent <- file.copy(Obs_PredImg, "Obs-Pred.png")
knitr::include_graphics("Obs-Pred.png")
```
