...
If you want to use this library for your research, I would be happy to collaborate and help you find the best ways of using it. Everything is not totally documented but vignettes will give you a good starting point (Please use citation). If you want to participate in converting this library into a cleaner one, please have a look at my todo list and feel free to clone, modify and provide pull requests.
...
- Add gradient boost model (gbm) and/or randomForest in a separate function <https://datascienceplus.com/gradient-boosting-in-r> and/or library caret.
...
- Re-integrate personal library `GeoDist` when also on github, for co-kriging.
- Add a functions for model averaging of all models not statistically worse than the best one.
